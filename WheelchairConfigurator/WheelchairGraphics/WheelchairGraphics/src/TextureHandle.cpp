...
VkResult VkLoader::TextureHandle::LoadTextureFromFile(std::string filepath, VkFormat format, VkEngine::VulkanTexture* texture)
{
	const bool forceLinear = false;
	const VkImageUsageFlags imageUsageFlags = VK_IMAGE_USAGE_SAMPLED_BIT;

	gli::texture2D tex2D(gli::load(filepath));
